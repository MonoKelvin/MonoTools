...
impl IndexCommand {
    async fn build_index(&self, ctx: &CommandContext) -> crate::error::Result<CommandOutput> {
    ...
    async fn update_index(&self, ctx: &CommandContext) -> crate::error::Result<CommandOutput> {
    ...
    async fn stats(&self, ctx: &CommandContext) -> crate::error::Result<CommandOutput> {
    ...
    async fn add_root(&self, ctx: &CommandContext, args: &[String]) -> crate::error::Result<CommandOutput> {
        if args.is_empty() {
    ...
    async fn remove_root(&self, ctx: &CommandContext, args: &[String]) -> crate::error::Result<CommandOutput> {
        if args.is_empty() {
