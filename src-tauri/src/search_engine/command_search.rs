...
impl CommandSearchEngine {
    ...
    pub fn new_empty_for_tests() -> Self {
        use crate::core::command::command_repo::InMemoryCommandRepo;
        Self {
            command_repo: Arc::new(InMemoryCommandRepo::new()),
        }
    }
...
impl crate::search_engine::search_source::SearchSource for CommandSearchEngine {
    ...
    fn category_weight(&self) -> f32 {
        crate::core::config::search::CATEGORY_WEIGHT_COMMANDS
    }
}
