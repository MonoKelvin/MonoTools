...
import { resolveIconByRegistry, iconSourceRegistry, type IconState } from '@/composables/iconSources'
import { ICON_CONFIG } from '@/config/icon'
import { extractPath } from '@/composables/iconSources/known'
...
/** 兼容导出: 旧 useAppIcon 调用方仍能从本文件 import IconKind / IconState. */
export type { IconKind, IconState } from '@/composables/iconSources'
